...
@Component({
  ...
  templateUrl: './edit-group-literature.component.html',
  styleUrls: ['./edit-group-literature.component.css']
})
export class EditGroupLiteratureComponent implements OnInit {
  form!: FormGroup;
